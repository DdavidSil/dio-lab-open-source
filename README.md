...
## Objetivo
Aprender o básico sobre contribuição no GitHub. E testar os 
...
> [!IMPORTANT]   
> Confira **TODAS** as instruções antes de enviar a sua contribuição em [CONTRIBUTING.md](https://github.com/digitalinnovationone/dio-lab-open-source/blob/main/CONTRIBUTING.md)
